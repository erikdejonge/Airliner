...
-(void) onEnterTransitionDidFinish
{
  ...
  // Start loading only after the incoming transition has fully finished.
  // The loader now runs synchronously, and replacing the scene from within
  // onEnter (while the intro transition is still active) would corrupt the
  // director's scene stack and freeze on the loading screen.
